...
parser.add_argument('--det_threshold', default=0.65, type=float)
...
# parser.add_argument('--det_weights_path', default='mmocr/soccernet-dbnetpp/finetuned-dbnet/epoch_10.pth', type=str, help='weights for the finetuned detector')
...
parser.add_argument('--det_weights_path', default='mmocr/soccernet-dbnetpp/finetuned-fcenet/epoch_10.pth', type=str, help='weights for the finetuned detector')
...
rec_infer = TextRecInferencer(model='a',device=device)

logger.info(f"Detector: Finetuned FCENet, Recognizer: SVTR-small")

correct = []
weighted_correct = []
cropped_path = args.data_path+'/debug/cropped'
